...
def store_cointegration_results(client, df_market_prices):
  ...
  for index, base_market in enumerate(markets[:-1]):
    ...
    for quote_market in markets[index +1:]:
      ...
      # base_candle_response = client.public.get_candles(
      #   market=base_market,
      #   resolution="1DAY",
      #   limit=2,
      # )
      # base_candle = base_candle_response.data["candles"][-1]

      # quote_candle_response = client.public.get_candles(
      #   market=quote_market,
      #   resolution="1DAY",
      #   limit=2,
      # )
